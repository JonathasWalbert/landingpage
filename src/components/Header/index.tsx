  ...
  return(
    <header className="bg-blueBri text-gray-400 p-6 text-sm md:text-lg fixed z-50 w-full">
      <ul className="flex gap-4 justify-center list-none">
        <li className="hover:scale-125 hover:text-white hover:animate-pulse-hover cursor-pointer" onClick={() => handleClick('home')}>Início</li>
        ...
        <li className="hover:scale-125 hover:text-white hover:animate-pulse-hover cursor-pointer" onClick={() => handleClick('contacts')}>Contato</li>
      </ul>
    </header>
  )
}
